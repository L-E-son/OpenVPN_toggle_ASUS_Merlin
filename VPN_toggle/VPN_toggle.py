...
browser = webdriver.Chrome("ADD YOUR CHROMEDRIVER LOCATION HERE") #You can use whichever browser you want, just be sure to make sure you have the correct driver mentioned above (look at the documentation or change the browser on this line and execute, you will be given the link)
browser.get(VPNpage)
